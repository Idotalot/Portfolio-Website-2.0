<?php
    ...
    <div id="menuWrapper">
        ...
        <div class="menuDiv menuList">
            <a class="menuButton" href="'.$basePath.'Pages/Startpagina">
                <div style="display: flex; padding: 12px;">
                    <i class="fa fa-home" aria-hidden="true"></i>
                    <p class="menuButtonText '.$hidden.'">Startpagina</p>
                </div>
            </a>
            <a class="menuButton" href="'.$basePath.'Pages/Ervaringen">
                <div style="display: flex; padding: 12px;">
                    <i class="fa fa-briefcase" aria-hidden="true"></i>
                    <p class="menuButtonText '.$hidden.'">Ervaringen</p>
                </div>
            </a>
            <a class="menuButton" href="'.$basePath.'Pages/Projecten">
                <div style="display: flex; padding: 12px;">
                    <i class="fa fa-folder" aria-hidden="true"></i>
                    <p class="menuButtonText '.$hidden.'">Projecten</p>
                </div>
            </a>  
            <a class="menuButton" href="'.$basePath.'Pages/Contact">
                <div style="display: flex; padding: 12px;">
                    <i class="fa fa-envelope" aria-hidden="true"></i>
                    <p class="menuButtonText '.$hidden.'">Contact</p>
                </div>
            </a>
            <a class="menuButton" href="'.$basePath.'Pages/Easter Eggs">
        ...
        <div class="menuDiv menuList hidden absolute bottom-0">
            <a class="menuButton" href="'.$basePath.'Pages/'.$accountHref.'">
                <div class="flex p-3">
                <!-- <div style="display: flex; padding: 12px;"> -->
